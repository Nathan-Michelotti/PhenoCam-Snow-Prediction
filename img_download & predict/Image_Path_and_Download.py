...
def generate_image_urls_sagehen(site_name, limit=5, save_to=None):
...
def generate_image_urls_sagehen2(site_name, limit=5, save_to=None):
    return _generate_image_urls(site_name, limit, start_year=2017, start_month=10, start_day=13, valid_minutes=[58, 28], save_to=save_to)


def generate_image_urls_sagehen3(site_name, limit=5, save_to=None):
    return _generate_image_urls(site_name, limit, start_year=2019, start_month=5, start_day=10, valid_minutes=[17, 47], save_to=save_to)
